    ...
    return (
        <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
            <div data-aos="fade-right"
                ...
                <div className='relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px-rgba(256,256,256,0.4)] rounded-full'>
                ...
                <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-wider my-8'>
                    ...
                    <br />
                    <FlipWords
                        words={["Development", "Courses", "Training"]}
                    />

                </h1>
                {/* Description */}
                <p className='text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
                    We deliver innovative IT solutions that harness technology and creativity to empower businesses with impactful experiences.</p>
            ...
            <Spline data-aos="fade-zoom-in"
                ...
                data-aos-delay="300"
                data-aos-offset="0"
                data-aos-duration="3000" className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full' scene="https://prod.spline.design/Fg4QbWGgDmJEfE6E/scene.splinecode" />
        </main>
    )
}
